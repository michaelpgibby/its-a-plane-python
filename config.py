...
DIVIDING_BAR_COLOR = COLORS.get(DIVIDING_BAR_COLOR, COLORS['BLUE'])
DATA_INDEX_COLOR = COLORS.get(DATA_INDEX_COLOR, COLORS['GREY'])
JOURNEY_COLOR = COLORS.get(JOURNEY_COLOR, COLORS['YELLOW'])
