...
FLIGHT_NUMBER_ALPHA_COLOUR = COLORS.get(FLIGHT_NUMBER_ALPHA_COLOR, COLORS['GREEN'])
FLIGHT_NUMBER_NUMERIC_COLOUR = COLORS.get(FLIGHT_NUMBER_NUMERIC_COLOR, COLORS['BLUE_DARK'])
